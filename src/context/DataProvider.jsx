...
export const DataProvider = ({ children }) => {
    ...
    const loginWithPhone = useCallback((phone, userObj = null) => {
        ...
        localStorage.setItem('accessToken', 'dummy-token-' + Date.now()); // Test uchun token
        ...
        // Auth holatini o'zgartirish
        setIsAuthenticated(true);

        console.log('✅ User ma\'lumotlari saqlandi:', userData);

        // Navigatsiya emas, faqat state o'zgartiramiz
        // Navigatsiya Login komponenti ichida amalga oshiriladi
